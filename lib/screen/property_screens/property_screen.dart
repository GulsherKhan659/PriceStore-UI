                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Obx(
                       ()=> Text("${_propertyController.filterPropertyList.length} Resualt",style: TextStyle(
                  ...
                  Expanded(child:Obx(() => ListView.builder(
                      ...
                      itemCount: _propertyController.filterPropertyList.length,
                      itemBuilder: (context,index){
                        return PropertyCard(constraint: constraint,  favouriteIcon: true, propertyBeanClass: _propertyController.filterPropertyList[index]);
                      })),),
                  Footer(),
                ],
              );
