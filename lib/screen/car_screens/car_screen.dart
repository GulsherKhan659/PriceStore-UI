              ...
              child:ListView(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      "${vehicleBeanClass!.title}",style: TextStyle(
                        fontSize: 25,
                        height: 1.2,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Model :${vehicleBeanClass!.model}",style: TextStyle(
                            height: 1.5,
                            fontSize: 15,
                            color: MyColor.font_color
                        ),),
                        Text("Mileage :${vehicleBeanClass!.mileage}",style: TextStyle(
                            fontSize: 15,
                            height: 1.5,
                            color: MyColor.icon_color
                        ),),
                        Text("Year :${vehicleBeanClass!.year}",style: TextStyle(
                            fontSize: 11,
                            height: 1.5,
                            color: MyColor.font_color
                        ),),
                        Text("Condition :${vehicleBeanClass!.condition}",style: TextStyle(
                            fontSize: 14,
                            height: 2,
                            fontWeight: FontWeight.bold,
                            color: MyColor.font_color
                       ...
                       Wrap(
                         ...
                         children:vehicleBeanClass!.ad_images!.map((e) => ImageCard(
                           width: width,
                           image: e,
                         ),).toList(),
                       ),
                        SizedBox(height: 5,),
                        Text("${vehicleBeanClass!.description}"
                          ,style: TextStyle(
                              color: MyColor.font_color
                          ),)
                      ],
