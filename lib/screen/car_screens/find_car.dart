               ...
               Expanded(
                    child: ListView(
                      ...
                      children: [
                          ...
                          child: Stack(
                            children: [
                              Container(
                                ...
                                child: Image(image: AssetImage("assets/car2.png"),fit: BoxFit.fitWidth,),
                              ),
                              Center(
                                child: Container(
                                  ...
                                  width: 220,
                                  child: Center(
                                    child: Text("Find Your Dream Car",textAlign: TextAlign.center,style:TextStyle(
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text("Avalible Cars ",style: TextStyle(color: MyColor.font_color,fontSize: 22),),
                              Container(
                                  width: 30,
                                  height: 30,
                                  //color: Colors.white70,
                                  child: GestureDetector(
                                      onTap: ()=>Get.toNamed(RouteName.CarFilterScreenRoute),
                      ...
                      Obx(()=>GridView.builder(
                        ...
                        return CarCard(vehicleBeanClass:_vDataController.vehicalList[index],);
                      }),),
                      ],
                    ),
                  ),
