              ...
              child: Column(
                children: [
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (c,i){
                          return Container(
                              ...
                              child: IconW(brandName: brandList[i],function: _vDataController.brandsName));
                        }),
                  ),
                  Container(
                    margin: const EdgeInsets.symmetric(vertical: 5,horizontal: 15),
                  ...
                  Container(
                    ...
                    child:Row(
                      children: [
                        HalfDropDown(optionList: FilterList.MIN,hintText: "Min",function: _vDataController.setMin,),
                        HalfDropDown(optionList: FilterList.MAX,hintText: "Max",function: _vDataController.setMax,),
                     ],
                    ),
                  ),
